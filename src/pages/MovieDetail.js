  ...
  useEffect(() => {
    ...
    axios
      ...
      .then((res) => {
        ...
        const searchPath = decodeURIComponent(
          ...
          <VideoPlayer
            ...
            movieInfo={{
              ...
              server:
                servers[currentServer]?.server_name,
              currentTime:
                resumeData?.episode === currentEp
                  ? resumeData.currentTime || 0
                  : 0
            }}
          />

          {/* Nút Tập trước / Tập tiếp */}
